  ...
  return (
    <section id='home' className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full'>
        <div className='py-2 flex-1 flex flex-col items-start  justify-center gap-6'>
            ...
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repellat, quo. Eum in molestiae, perferendis impedit officiis consequuntur nostrum modi maxime. Possimus voluptate atque deserunt ex autem optio laborum consectetur aliquid.
            </p>
        ...
        <div className='py-2 flex-1 flex items-center relative'>
            ...
            <div className='w-full h-full absolute top-0 left-0 flex flex-wrap gap-4 items-center justify-center  py-4 drop-shadow-lg lg:px-32'>
                {heroData && heroData.map(n =>(
                    <div key ={n.id} className='lg:w-190 p-4 bg-cardOverlay backdrop-blur-md rounded-3xl flex flex-col items-center justify-center'>
                        ...
                        <p className='text-sm font-semibold text-headingColor'><span className='text-lg text-red-600'><BiRupee className='inline'/></span>{n.price}</p>
                    </div>
                ))}
            </div>
        </div>
